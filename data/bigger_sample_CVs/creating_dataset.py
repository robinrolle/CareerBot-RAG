...
PDF_DIR = os.path.abspath(os.path.join(BASE_DIR, '..', '..', 'data', 'bigger_sample_CVs'))
TEXT_DATASET_DIR = os.path.abspath(os.path.join(BASE_DIR, '..', '..', 'data', 'bigger_sample_CVs', 'text_datasets'))
